// GPU Tuning Module
// Derived from the oudenos internal GPU-optimization notes.
...
export const gpuActions: TuningActionDefinition[] = [
  ...
  },
  {
    ...
    rationale: "NVIDIA GPUs dynamically transition between power states (P0=max, P2=intermediate, P8=idle) based on load. These transitions introduce latency spikes of 5-50ms as the GPU ramps clocks. Locking to P-State 0 eliminates transition latency at the cost of higher idle power and temperatures. This is one of the highest-impact GPU latency tweaks in the oudenos lab notes.",
    tier: "premium",
    risk: "medium",
    compatibility: { minBuild: 7600 },
    dependencies: [],
