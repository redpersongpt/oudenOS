        ...
        {donated ? (
          ...
          >
            ...
            <div className="flex min-h-0 flex-1 flex-col">
              ...
              <div
                ref={scope}
                className="flex-1 overflow-y-auto rounded-sm border border-[var(--border)] bg-[var(--surface)]"
              >
                <ul className="p-2 space-y-0.5">
                  {SUPPORTERS.map((s, i) => (
                    <motion.li
                      ...
                      className="flex items-center gap-2.5 rounded-sm px-3 py-2 hover:bg-[var(--surface-raised)] transition-colors"
                    >
                      <span className="text-base leading-none">{s.flag}</span>
                      <span className="flex-1 text-xs font-medium text-[var(--text-secondary)]">
                        {s.name}
                      </span>
                      <span className="text-xs font-medium text-[var(--accent)]">${s.amount}</span>
                    </motion.li>
                  ))}
                </ul>
              </div>
